...
[ExcludeFromCodeCoverage]
public class AsyncTestMapper : IAsyncMappingDefinition<TestSourceClass, TestDestinationClass>
{
    public async Task<TestDestinationClass> MapAsync(TestSourceClass source)
    {
        return new TestDestinationClass()
        {
            Id = default,
